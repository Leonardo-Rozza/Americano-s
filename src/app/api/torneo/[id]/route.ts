...
export async function GET(request: Request, { params }: RouteParams) {
  return runApiRoute(
    request,
    {
      operation: "torneo.get",
      fallbackMessage: "No se pudo obtener el torneo.",
    },
    async (context) => {
      ...
      if (torneo.formato === "LARGO" && torneo.deporte === "PADEL") {
        ...
        return ok({
          ...torneo,
          largoRanking: {
            groups: largoRanking.groupRankings,
...
export async function DELETE(request: Request, { params }: RouteParams) {
  return runApiRoute(
    request,
    {
      operation: "torneo.delete",
      fallbackMessage: "No se pudo eliminar el torneo.",
    },
    async (context) => {
      const authUser = await requireApiAuth(request);
      context.userId = authUser.userId;
...
export async function PUT(request: Request, { params }: RouteParams) {
  return runApiRoute(
    request,
    {
      operation: "torneo.update",
      fallbackMessage: "No se pudo actualizar el torneo.",
    },
    async (context) => {
      const authUser = await requireApiAuth(request);
      context.userId = authUser.userId;
